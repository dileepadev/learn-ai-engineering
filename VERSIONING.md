...
3. Commit changes with a version-related message (e.g. `chore: Release v1.2.0`)
4. Tag the release:
...
5. (Optional) Create a GitHub release and paste the relevant changelog section
...
If you have questions about the versioning strategy or encounter version-related problems, feel free to open an issue on the [GitHub repository](https://github.com/dileepadev/learn-ai-engineering/issues).
